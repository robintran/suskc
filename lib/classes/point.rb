class Point
  def self.make_point(location)
    ...
    point[:data] = {id: location.id, name: location.name, email: location.email, address: location.address, phone: location.phone, url: location.url, twitter: location.twitter, facebook: location.facebook, description: location.description, logo: logo, events: location.js_events.to_json}
